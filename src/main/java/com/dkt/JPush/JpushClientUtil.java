...
public class JpushClientUtil {
    ...
    private final static String appKey = "953015633fdc1595d960b9ed";

    private final static String masterSecret = "5789a5e43c05e4eee1bf5586";
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(AndroidNotification.newBuilder()
                                ...
                                .setAlert(notification_title)
                                //.setTitle(SysConst.JPUSH_NOTIFICATION_TITLE)
                ...
                .setOptions(Options.newBuilder()
                        //此字段的值是用来指定本推送要推送的apns环境，false表示开发，true表示生产；对android和自定义消息无意义
                        .setApnsProduction(SysConst.APNS_ENVIRONMENT)
                        //此字段是给开发者自己给推送编号，方便推送者分辨推送记录
                        .setSendno(1)
